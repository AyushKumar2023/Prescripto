  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          <p className='font-medium'>Address:</p>
          {
            ...
            ? <p>
              ...
              <br />
              <input className='bg-gray-50' type="text" value={userData.address.line2} onChange={(e)=> setUserData(prev => ({...prev, address:{...prev.address, line1:e.target.value}}))}/>
            </p>
      ...
      <div className='mt-10'>
        {
          isEdit
          ? <button className='cursor-pointer border border-[#5f6fff] px-8 py-2 rounded-full hover:bg-[#5f6fff] hover:text-white transition-all duration-500' onClick={()=>(setIsEdit(false))}>Save Information</button>
